const CONFIG = {
    ...
    btnYes: 'không cutee xíu nào 😢 <3',
    btnNo: 'cutee đáng đáng yêu nhất hệ mặt trời:))',
    question: 'Nói cho tới lý do vì sao cậu nghĩ vậy đi <3',
    btnReply: 'Gửi cho Tuyên',
    reply: 'Tại vì ai cũng nói mình không cutee :<',
